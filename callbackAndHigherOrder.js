...
const contains = (arr, firstName, callback) => {

  arr.includes(firstName) ? callback(true) : callback(false)
  }
...
let addNumberSix = addingFactory(6)
let tryTwo = addNumberSix(6)
console.log(tryTwo)
